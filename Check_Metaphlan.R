# 6/11/20
# Checks summation of unlogged metaphlan values

library(tidyverse)
data_dir <- "Data/Tidy"
graph_dir <- "Graphs/Metaphlan/Check_Distribution_Scaled"
...
check_distribution <- function(met_lev, met_reg, met_lab, is_batch = F, coll_type = "omni") {
  print(met_lev)
  
  graph_dir2 <- graph_dir
