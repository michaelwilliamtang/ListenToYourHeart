# 6/11/20
# Compares batch vs unbatch for hf patients in PCL

library(tidyverse)
data_dir <- "Data/Tidy"
graph_dir <- "Graphs/PCL/HF_Batched_vs_Unbatched_Scaled"
...
batch_vs_unbatch_comp_hf <- function(pcl_lab, sing_lab, N, comp_N, hf_tok) {
...
batch_vs_unbatch_comp_hf(pcl_lab = "Pathways", sing_lab = "Pathway", N = 40, comp_N = 20, hf_tok = 1)